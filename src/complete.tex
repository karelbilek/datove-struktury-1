...
Skripta byla napsána profesorem Koubkem; pan profesor je dal k dispozici Karlovi Bílkovi a Markovi Vašutovi, kteří z~nich \uv{svévolně} udělali tuto upravenou verzi v LaTeXu. Některé části tedy nemusí být správné. Delší důkazy, ve kterých mi v~původních skriptech chyběla struktura, jsem přepsal na sérii drobnějších lemmat, doufám, že to bude jasnější.
...
\emph{(pozn.: sekce \uv{nepřesný popis} jsou opravdu nepřesné)}
...
{\bf MEMBER$(x)$}\newline 
Spočítáme $i:=h(x)$\newline 
{\bf \textsf{if}} $i.previous\ne$prázdné nebo $i.key=$prázdné {\bf \textsf{then} Výstup}: $
x\notin S$, stop {\bf \textsf{endif} \newline 
\textsf{while}} $i.next\ne$prázdné a $i.key\ne x$ {\bf \textsf{do}} $i:=i.next$ {\bf \textsf{enddo}\newline 
...
DELETE$(x)$}\newline 
Spočítáme $i:=h(x)$\newline 
{\bf \textsf{if}} $i.previous\ne$prázdné nebo $i.key=$prázdné {\bf \textsf{then}} stop {\bf \textsf{endif}\newline 
\textsf{while}} $i.next\ne$prázdné a $i.key\ne x$ {\bf \textsf{do}} $i:=i.next$ {\bf \textsf{enddo} \newline 
\textsf{if}} $i.key=x$ {\bf \textsf{then}}\newline  
\phantom{---}{\bf \textsf{if}} $i.previous\ne$prázdné {\bf \textsf{then}}\newline 
\phantom{------}$(i.previous).next:=i.next$\newline 
\phantom{------}{\bf \textsf{if}} $i.next\ne$prázdné {\bf \textsf{then}} $(i.n
ext).previous:=i.previous$ {\bf \textsf{endif}}\newline 
\phantom{------}$i.key:=i.next:=i.previous:=$ prázdné \newline 
\phantom{---}{\bf \textsf{else}}\newline 
\phantom{------}{\bf \textsf{if}} $i.next\ne$prázdné {\bf \textsf{then}}\newline 
\phantom{---------}$i.key:=(i.next).key$, $i.next:=(i.next).next$\newline 
\phantom{---------}{\bf \textsf{if}} $((i.next).next)\ne$prázdné {\bf \textsf{then}} $
((i.next).next).previous:=i$ {\bf \textsf{endif}}\newline 
...
{\bf INSERT$(x)$}\newline 
Spočítáme $i:=h(x)$\newline
{\bf \textsf{if}} $i.key=NIL$ {\bf \textsf{then}} $i.key:=x$, stop {\bf \textsf{endif}}\newline 
{\bf \textsf{if}} $i.previous\ne NIL${\bf \textsf{then}}\newline 
\phantom{---}{\bf \textsf{if}} neexistuje prázdný řádek tabulky {\bf \textsf{then}}\newline 
...
\phantom{------}{\bf \textsf{if}} $j.next\ne NIL$ {\bf \textsf{then}} $(j.next).previous:=j$ {\bf \textsf{endif}}\newline 
\phantom{---------}$i,key:=x$, $i.next:=i.previous:=$prázdné\newline 
\phantom{------}{\bf \textsf{endif}}\newline 
\phantom{---}{\bf \textsf{endif}\newline 
\textsf{else}}\newline 
\phantom{---}{\bf \textsf{while}} $i.next\ne NIL$ a $i.key\ne x$ {\bf \textsf{do}} $i:=i.next$ {\bf \textsf{enddo}}\newline 
\phantom{---}{\bf \textsf{if}} $i.key\ne x$ {\bf \textsf{then}}\newline 
\phantom{------}{\bf \textsf{if}} neexistuje prázdný řádek tabulky {\bf \textsf{then}}\newline 
\phantom{---------}{\bf Výstup}: přeplnění\newline 
\phantom{------}{\bf \textsf{else}}\newline 
\phantom{---------}nechť $j$ je volný řádek tabulky\newline 
...
Spočítáme $i:=h(x)$\newline 
{\bf \textsf{if}} $i.begin=$prázdné {\bf \textsf{then} Výstup}: $x\notin S$, stop {\bf \textsf{else}} $i:=i.begin$ {\bf \textsf{endif}\newline 
\textsf{while}} $i.next\ne$prázdné a $i.key\ne x$ {\bf \textsf{do}} $i:=i.next$ {\bf \textsf{enddo} \newline 
\textsf{if}} $i.key=x$ {\bf \textsf{then} Výstup}: $x\in S$ {\bf \textsf{else} Výstup}: $
x\notin S$ {\bf \textsf{endif}
}
...
DELETE$(x)$}\newline 
Spočítáme $i:=h(x)$\newline 
{\bf \textsf{if}} $i.begin=$prázdné {\bf \textsf{then}} stop {\bf \textsf{else}} $j:=i$, $
i:=i.begin$ {\bf \textsf{endif}\newline 
\textsf{while}} $i.next\ne$prázdné a $i.key\ne x$ {\bf \textsf{do}} $j:=i$, $i:
=i.next$ {\bf \textsf{enddo} \newline 
\textsf{if}} $i.key=x$ {\bf \textsf{then}\newline 
\phantom{{\rm ---}}\textsf{if}} $i=j.begin$ {\bf \textsf{then}\newline 
\phantom{{\rm ------}}\textsf{if}} $i.next\ne$prázdné {\bf \textsf{then}\newline 
\phantom{{\rm ---------}}$j.begin:=i.next$\newline 
\phantom{{\rm ------}}\textsf{else}\newline 
...
{\bf INSERT$(x)$}\newline 
Spočítáme $i:=h(x)$\newline 
{\bf \textsf{if}} $i.begin=$prázdné {\bf \textsf{then}}\newline 
\phantom{---}{\bf \textsf{if}} $i.key=$prázdné {\bf \textsf{then}}\newline 
...
\end{itemize}
\item \uv{Nestandardní} -- bez písmene navíc :) -- tabulka rozšířena o pomocnou tabulku, kam ukládám jako první
\begin{itemize}
...
\subsubsection{Očekávaný počet testů neúspěšného vyhledávání ($s_{n+1}\notin S$) }
...
testů je $l-i+1$ -- počet testů znamená \uv{projet} kompletní zbytek řetězce.
\end{myproof}
...
\begin{lemma}[Rekurentní vztah pro $c_n(l)$]
...
\begin{lemma}[součet binomických hodnot]
...
\begin{lemma}[Rekurentní vztah pro $S_n$]
...
\begin{lemma}[První vztah pro $S_n$]
...
\begin{lemma}[Druhý vztah pro $S_n$]
...
\begin{veta}[Odhad nejhoršího případu]
    Očekávaný počet testů při neúspěšném 
...
\algoritmus{{\bf INSERT$(x)$}\newline 
Spočítáme $i:=h(x)$\newline 
{\bf \textsf{if}} $i.next=NIL$ {\bf \textsf{then}} $i.next=x$, stop {\bf \textsf{endif}\newline 
\textsf{while}} $i.next\ne NIL$ a $i.key\ne x$ {\bf \textsf{do}} $i:=i.next$ {\bf \textsf{enddo}\newline 
\textsf{if}} $i.key\ne x$ {\bf \textsf{then}}\newline 
\phantom{---}{\bf \textsf{if}} neexistuje prázdný řádek tabulky {\bf \textsf{then}}\newline 
\phantom{------}{\bf Výstup}: přeplnění\newline 
...
{\bf \textsf{if}} $i.next=NIL$ {\bf \textsf{then}} $i.next=x$, stop {\bf \textsf{endif}\newline 
\textsf{while}} $i.next\ne NIL$ a $i.key\ne x$ {\bf \textsf{do}}\newline 
\phantom{---}{\bf \textsf{if}} $k$ není definováno a $i.next<m$ {\bf \textsf{then}} $k:=i$ {\bf \textsf{endif}\newline 
...
{\bf \textsf{enddo}\newline 
\textsf{if}} $i.key\ne x$ {\bf \textsf{then}}\newline 
\phantom{---}{\bf \textsf{if}} neexistuje prázdný řádek {\bf \textsf{then}}\newline 
\phantom{------}{\bf Výstup}: přeplnění\newline 
\phantom{---}{\bf \textsf{else}}\newline 
\phantom{------}nechť $j$ je volný řádek, $j.key:=x$\newline 
\phantom{------}{\bf \textsf{if}} $k$ není definováno {\bf \textsf{then}}\newline 
\phantom{---------}$i.next:=j$\newline 
\phantom{------}{\bf \textsf{else}}\newline 
...
\end{lemma}
\begin{myproof}
    V důkazu \uv{vtipně} přehodíme, přes co vlastně sčítáme, a použijeme definici $c$-univerzálního systému.
...
\begin{lemma}[Pomocné lemma]Když $t\ge 6$ a $m(\ln m+\ln\ln m)<N$, pak $m<\frac {
p_t}{\ln t}$.
\end{lemma}
...
\begin{lemma}[Technické lemma]Mějme reálná čísla $b_i$ pro $i=0,1
,\dots,m-1$ a 
...
Použijeme předchozí lemma o obecné funkci a při sčítání si \uv{vtipně} přehodíme, přes co vlastně sčítáme, a poté využijeme toho, že $H$ je $c$-univerzální.
...
\begin{lemma}[Postačující podmínka]
    Když 
...
\begin{myproof}
Všech matic je $m^{Nt},$ a tedy  když $\binom Nn(m^n-\prod_{i=0}^{n-1}(m-i))^tm^{(N-n)t}<m^{Nt},$ pak nutně existuje $(N,m,n)$-perfektní systém, protože nějaká matice, co ho reprezentuje, se \uv{najde}.
\end{myproof}
...
\begin{lemma}[Podmínka perfektnosti]Funkce $h_k$ je perfektní, právě když 
...
Teď použijeme podobný \uv{trik} s~modulem, jako předtím.
...
Neformálně: Nyní všechny funkce $\mathbf{A,B,C,D}$ \uv{zkombinujeme} dohromady.
...
\in \mathcal H_{m(j)^2}$\newline 
\phantom{---------}{\bf enddo}\newline 
\phantom{---------}{\bf \textsf{for every}} $y\in S_j$ {\bf do} vložíme $
...
\phantom{---}{\bf \textsf{for every}} $i=0,1,\dots,s-1$ {\bf do} $
...
\phantom{---}{\bf enddo\newline 
enddo\newline 
\textsf{for every}} $x\in S$ {\bf do INSERT$(x)$ enddo}
...
\algoritmus{{\bf MEMBER$(x)$\newline 
\textsf{if}} $x=A(1)$ {\bf \textsf{then}}\newline 
\phantom{---}{\bf Výstup}: $x\in S$ {\bf \textsf{stop}}\newline 
{\bf \textsf{else}}\newline 
\phantom{---}{\bf \textsf{if}} $x<A(1)$ {\bf \textsf{then}}\newline 
\phantom{------}{\bf Výstup}: $x\notin S$ {\bf \textsf{stop}}\newline 
\phantom{---}{\bf \textsf{else}}\newline 
\phantom{------}$d=1$\newline 
\phantom{---}{\bf \textsf{endif}\newline
\bf \textsf{endif}\newline 
\textsf{if}} $x=A(|S|)$ {\bf \textsf{then}}\newline 
\phantom{---}{\bf Výstup}: $x\in S$ {\bf \textsf{stop}}\newline 
{\bf \textsf{else}}\newline 
\phantom{---}{\bf \textsf{if}} $x>A(|S|)$ {\bf \textsf{then}}\newline 
\phantom{------}{\bf Výstup}: $x\notin S$ {\bf \textsf{stop}}\newline 
\phantom{---}{\bf \textsf{else}}\newline 
\phantom{------}$h=|S|$\newline 
\phantom{---}{\bf \textsf{endif}\newline
\textsf{endif}\newline 
\textsf{while}} $d+1<h$ {\bf \textsf{do}}\newline 
\phantom{---}$n:=\text{{\bf next}}(d,h)$\newline 
\phantom{---}{\bf \textsf{if}} $\bold x=A(n)$ {\bf \textsf{then}}\newline 
\phantom{------}{\bf Výstup}: $\bold x\in S$ {\bf \textsf{stop}}\newline 
\phantom{---}{\bf \textsf{else}}\newline 
\phantom{------}{\bf \textsf{if}} $x<A(n)$ {\bf \textsf{then}} $h:=n$ {\bf \textsf{else}} $d:=n$ {\bf \textsf{endif}}\newline 
\phantom{---}{\bf \textsf{endif}\newline 
\textsf{enddo}\newline 
Výstup}: $x\notin S$ {\bf \textsf{stop}}
}
...
formální největší prvek (a ten je pak \uv{uložen} zvlášť). Je to prostorově 
...
\algoritmus{{\bf Vyhledej$(x)$\newline 
$t:=$}kořen stromu $T$, $w:=NIL$\newline 
{\bf \textsf{while}} $t$ není list {\bf \textsf{do}}\newline 
\phantom{---}$i:=1$\newline 
\phantom{---}{\bf \textsf{while}} $H_t(i)<x$ a $i<\rho (t)$ {\bf \textsf{do}} $i:=i+1$ {\bf \textsf{enddo}}\newline 
\phantom{---}{\bf \textsf{if}} $H_t(i)=x$ {\bf \textsf{then}} $w:=t$ {\bf \textsf{endif}}\newline 
$t:=S_t(i)$ {\bf \textsf{enddo} Výstup}: $t$ a $w$.
}
\algoritmus{
{\bf MEMBER$(x)$\newline 
Vyhledej$(x)$\newline 
\textsf{if}} $\key(t)=x$ {\bf \textsf{then} Výstup}: $x\in S$ {\bf \textsf{else} Výstup}: $x\notin S$ {\bf \textsf{endif}
}}
\algoritmus{
{\bf
INSERT$(x)$\newline
...
\phantom{------}{\bf \textsf{while}} $j\ge i$ {\bf \textsf{do}\newline 
...
{\bf \textsf{if}} $i<\rho (u)$ {\bf \textsf{then}} $S_u(\rho (u)+1):=S_u(\rho (u))$ {\bf \textsf{endif}\newline}
$j:=\rho (u)-1$, $\rho (u):=\rho (u)+1$,\newline 
{\bf \textsf{while}} $j>i$ {\bf \textsf{do}}\newline 
\phantom{---}$S_u(j+1):=S_u(j)$, $H_u(j+1):=H_u(j)$, $j:=j-1$\newline 
{\bf \textsf{enddo}\newline 
...
\phantom{---}{\bf \textsf{if}} $w\ne u$ a $w\ne NIL$ {\bf \textsf{then}} $H_w(j):=H_u(\rho (u)-1)$ {\bf \textsf{endif}}\newline 
\phantom{---}{\bf \textsf{while}} $k<\rho (u)-1$ {\bf \textsf{do}}\newline 
\phantom{------}$H_u(k):=H_u(k+1)$, $S_u(k):=S_u(k+1)$, $k:=k+1$ \newline 
\phantom{---}{\bf \textsf{enddo}}\newline 
\phantom{---}{\bf \textsf{if}} $i\ne\rho(u)$ {\bf \textsf{then}} $S_u(\rho (u)-1):=S_u(\rho (u))$ {\bf \textsf{endif}}\newline
\phantom{---}$\rho (u):=\rho (u)-1$, odstraň $t$, $t:=u$ \newline 
\phantom{---}{\bf \textsf{while}} $\rho (t)<a$ a $t$ není kořen {\bf \textsf{do}}\newline 
\phantom{------}$y$ je bezprostřední bratr $t$\newline 
\phantom{------}{\bf \textsf{if}} $\rho (y)=a$ {\bf \textsf{then} Spojení$(t,y)$ \textsf{else} Přesun$
(t,y)$ \textsf{endif}}\newline 
\phantom{---}{\bf \textsf{enddo}\newline 
\textsf{endif}}}
\algoritmus{
...
\phantom{---}{\bf \textsf{if}} $i=2$ {\bf \textsf{then}} vlož podstrom vrcholu $S_t(1)$ \textsf{do} $Z_1$ 
{\bf \textsf{endif}}\newline 
\phantom{---}{\bf \textsf{if}} $i>2$ {\bf \textsf{then}}\newline 
\phantom{------}vytvoř nový vrchol $t_1$, $\rho (t_1)=i-1$,\newline 
\phantom{------}{\bf \textsf{for every}} $j=1,2,\dots,i-2$ {\bf \textsf{do}}\newline 
\phantom{---------}$S_{t_1}(j):=S_t(j)$, $H_{t_1}(j):=H_t(j)$\newline 
\phantom{------}{\bf \textsf{enddo}}\newline 
\phantom{------}$S_{t_1}(i-1):=S_t(i-1)$, vlož podstrom vrcholu $t_1$ \textsf{do} $Z_1$\newline 
\phantom{---}{\bf \textsf{endif}}\newline 
\phantom{---}{\bf \textsf{if}} $i=\rho (t)-1$ {\bf \textsf{then}}\newline 
\phantom{------}vlož podstrom $S_t(\rho (t))$ \textsf{do} $Z_2$ 
\phantom{---}{\bf \textsf{endif}}\newline 
\phantom{---}{\bf \textsf{if}} $i<\rho (t)-1$ {\bf \textsf{then}}\newline 
\phantom{------}vytvoř nový vrchol $t_2$, $\rho (t_2):=\rho (t)-i$\newline 
\phantom{------}{\bf \textsf{for every}} $j=1,2,\dots,\rho (t)-i-1$ {\bf \textsf{do}}\newline 
\phantom{---------}$S_{t_2}(j):=S_t(i+j)$, $H_{t_2}(j):=H_t(i+j)$\newline 
\phantom{------}{\bf \textsf{enddo}}\newline 
\phantom{------}$S_{t_2}(\rho (t)-i):=S_t(\rho (t))$, vlož podstrom $t_2$ \textsf{do} $Z_2$ \newline 
\phantom{---}{\bf \textsf{endif}\newline 
\textsf{enddo}\newline 
\textsf{if}} $\key(t)=x$ {\bf \textsf{then}}\newline 
...
$A$-{\bf Insert$(x)$\newline 
$t:=\Prv$\newline
\textsf{while}} $t\ne\text{\rm kořen }T$ a $H_t(1)<x$ {\bf \textsf{do} $t:=\otec(t)$ \textsf{enddo}\newline 
\textsf{while}} $t\ne\text{\rm list}$ {\bf \textsf{do}}\newline 
\phantom{---}$i:=1$\newline 
\phantom{---}{\bf \textsf{while}} $H_t(i)<x$ a $i<\rho (t)$ {\bf \textsf{do}} $i:=i+1$ {\bf \textsf{enddo}}\newline 
\phantom{---}{\bf \textsf{if}} $i>1$ {\bf \textsf{then}} $v:=S_t(i-1)$ {\bf \textsf{else}} $v:=S_t(\rho (t))$ {\bf \textsf{endif}}\newline 
\phantom{---}$t:=S_t(i)$\newline 
{\bf \textsf{enddo}\newline 
\textsf{if}} $\key(t)\ne x$ {\bf \textsf{then}\newline }
\phantom{---}vytvoř nový list $t'$, $\key(t')=x$,\newline
\phantom{---}{\bf \textsf{if}} $t$ je kořen {\bf \textsf{then}}\newline 
...
\phantom{---------}{\bf \textsf{enddo}}\newline 
\phantom{---------}$S_u(i):=t'$, $H_u(i):=x$, $\rho (u):=\rho (u)+1$,\newline 
\phantom{---------}{\bf \textsf{if}} $t=\Prv$ {\bf \textsf{then}} $\Prv:=t'$ {\bf \textsf{endif}}\newline 
\phantom{------}{\bf \textsf{endif}}\newline 
\phantom{------}$t:=u$\newline 
\phantom{------}{\bf \textsf{while}} $\rho (t)>b$ {\bf \textsf{do} Štěpení$(t)$ \textsf{enddo}}\newline 
\phantom{---}{\bf \textsf{endif}\newline 
...
\begin{pozorovani}[Plyne z minulého]
    Všechny 
...
$b$ se dá vnímat jako \uv{vzdálenost} počtu synů od krajních hodnot $a$ a $b$, ale s~horním omezením $c$.
...
Tj. jde o a,b strom s~jedním \uv{pokaženým} vrcholem.
...
\phantom{---}{\bf \textsf{if}} $\key(t)>x$ {\bf \textsf{then}} $t:=\levy(t)$ {\bf \textsf{else}} $t:=\pravy(t)$ {\bf \textsf{endif}\newline 
\textsf{enddo}
}}\algoritmus{{\bf

MEMBER$(x)$\newline 
Vyhledej$(x)$\newline 
\textsf{if}} $t$ není list {\bf \textsf{then} Výstup}: $x\in S$ {\bf \textsf{else} Výstup}: $
x\notin S$ {\bf \textsf{endif}
}}\algoritmus{{\bf
INSERT$(x)$\newline 
Vyhledej$(x)$\newline 
\textsf{if}} $t$ je list {\bf \textsf{then}}\newline 
...
\phantom{---}{\bf \textsf{if}} $\levy(t)$ je list {\bf \textsf{then}\newline}
\phantom{------}odstraníme vrchol $\levy(t)$, $\otec(\pravy(t)):=\otec(t)$\newline 
\phantom{------}{\bf \textsf{if}} $t=\levy(\otec(t))$ {\bf \textsf{then}}\newline
...
\phantom{---}{\bf \textsf{else}}\newline 
\phantom{------}$u:=\levy(t)$\newline 
\phantom{------}{\bf \textsf{while}} $\pravy(u)$ není list {\bf \textsf{do}}\newline \phantom{---------}$u:=\pravy(u)$\newline 
\phantom{------}{\bf \textsf{enddo}}\newline 
\phantom{------}$\key(t):=\key(u)$, odstraníme vrchol $\pravy(u)$,\newline 
\phantom{------}$\otec(\levy(u)):=\otec(u)$\newline 
\phantom{------}{\bf \textsf{if}} $u=\levy(\otec(u))$ {\bf \textsf{then}}\newline 
...
\phantom{------}{\bf \textsf{if}} $T_1$ je prázdný strom {\bf \textsf{then}}\newline \phantom{---------}$T_1:=\text{\rm podstrom vrcholu }t$\newline
\phantom{------}{\bf \textsf{else}}\newline 
...
{\bf Rotace$(v,u)$\newline} 
$\otec(u):=\otec(v)$,\newline 
{\bf \textsf{if}} $v=\levy(\otec(v))$ {\bf \textsf{then}}\newline 
\phantom{---}$\levy(\otec(v)):=u$\newline 
{\bf \textsf{else}}\newline 
\phantom{---}$\pravy(\otec(v)):=u$\newline 
{\bf \textsf{endif}\newline 
$\otec(v):=u$\newline 
\textsf{if}} $u=\levy(v)$ {\bf \textsf{then}}\newline 
...
\begin{enumerate}
   \item $\omega (t)=-1$, můžeme provést jednoduchou rotaci {\bf Rotace$(v,t)$}, tj. $t$ půjde \uv{nahoru}, levý syn zůstane $t_1$, pravý syn bude $v$, který bude mít za levého syna $t_2$. Pak stačí položit 
    $\omega (v)=\omega (t)=0$, nic nepropagujeme výš.
    
    \item $\omega (t)=1$ -- jednoduchou rotaci neprovedeme, protože by se \uv{levá větev} příliš zkrátila. Uděláme tedy {\bf Dvojita-rotace$(v,t,t_2)$} -- $t_2$ půjde \uv{nahoru}, zavěsí se za něj $v$ a $t$ a rozdělí si jeho \uv{děti}. Musíme udělat analýzu pro všechny tři případy $\omega (t_2)$.
    \begin{enumerate}
...
Popíšeme proceduru {\bf Kontrola-INSERT} (vychází z~analýzy výše)


\algoritmus{
{\bf Kontrola-INSERT$(t)$\newline 
$v:=\otec(t)$\newline 
\textsf{if}} $t=\levy(v)$ {\bf \textsf{then}}\newline 
\phantom{---}{\bf Leva-Kontrola-INSERT$(t)$\newline 
\textsf{else}}\newline 
\phantom{---}{\bf Prava-Kontrola-INSERT$(t)$\newline 
\textsf{endif}}
}


\algoritmus{
{\bf Leva-Kontrola-INSERT$(t)$}\newline 
{\bf \textsf{if}} $\omega (v)=1$ {\bf \textsf{then}}\newline 
\phantom{---}$\omega (v):=0$ \newline 
{\bf \textsf{else}}\newline 
\phantom{---}{\bf \textsf{if}} $\omega (v)=0$ {\bf \textsf{then}}\newline 
\phantom{------}$\omega (v):=-1$, $t:=v$, {\bf Kontrola-INSERT}$(t)$\newline 
\phantom{---}{\bf \textsf{else}}\newline
\phantom{------}{\bf \textsf{if}} $\omega (t)=-1$ {\bf \textsf{then}}\newline 
\phantom{---------}{\bf Rotace$(v,t)$}, $\omega (v):=0$, $\omega (t):=0$\newline 
\phantom{------}{\bf \textsf{else}}\newline 
\phantom{---------}$w:=\pravy(t)$, {\bf Dvojita-rotace$(v,t,w)$},\newline 
\phantom{---------}{\bf \textsf{if}} $\omega (w)=0$ {\bf \textsf{then}}\newline 
\phantom{------------}$\omega (t):=0$, $\omega (v):=0$\newline 
\phantom{---------}{\bf \textsf{else}}\newline 
\phantom{------------}{\bf \textsf{if}} $\omega (w)=1$ {\bf \textsf{then}}\newline 
...
\begin{enumerate}
    \item  když $\omega (v)=0$, tak jsme jen z~\uv{vyváženého} vrcholu udělali nevyvážený, tedy $\eta (u)=a+1$ a $\eta (v)=a+2$. 
    
    Stačí položit $\omega (v)=1$ a skončit.
    \item Když $\omega (v)=-1,$ tak jsme strom, \uv{vychýlený} doleva \uv{narovnali} - tj. změníme číslo a propagujeme výš.
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            \item $\omega (u_1)=0\implies\eta (u_3)=\eta (u_4)=a$ a tedy 
            $\eta (v)=\eta (u)=a+1$ a $\eta (u_1)=a+2$. Proto položíme 
            $\omega (v)=\omega (u_1)=\omega (u)=0$ a zavoláme proceduru {\bf Kontrola-DELETE }
            na vrchol $u_1$.
            
            \item $\omega (u_1)=1\implies\eta (u_3)=a-1,\,\eta (u_4)=a$ a tedy 
            $\eta (v)=\eta (u)=a+1$ a $\eta (u_1)=a+2$. Proto položíme 
...
$v:=\otec(t)$\newline 
\textsf{if}} $t=\levy(v)$ {\bf \textsf{then}}\newline 
\phantom{---}{\bf Leva-Kontrola-DELETE \newline 
\textsf{else}}\newline
\phantom{---}{\bf Leva-Kontrola-DELETE \newline 
\textsf{endif}}}

\algoritmus{
{\bf Leva-Kontrola-DELETE$(t)$}\newline 
{\bf \textsf{if}} $\omega (v)=1$ {\bf \textsf{then}}\newline 
\phantom{---}$u:=\pravy(v)$\newline 
\phantom{---}{\bf \textsf{if}} $\omega (u)\ge 0$ {\bf \textsf{then}}\newline 
...
\phantom{------}$\omega (v):=1$\newline 
\phantom{---}{\bf \textsf{else}}\newline 
\phantom{------}$\omega (v):=0$, $t:=v$, {\bf Kontrola-DELETE}$(t)$\newline \phantom{---}{\bf \textsf{endif}\newline }
}

\algoritmus{
{\bf Prava-Kontrola-DELETE$(t)$}\newline 
{\bf \textsf{if}} $\omega (v)=-1$ {\bf \textsf{then}}\newline 
\phantom{---}$u:=\levy(v)$\newline 
\phantom{---}{\bf \textsf{if}} $\omega (u)\le 0$ {\bf \textsf{then}}\newline 
\phantom{------}{\bf Rotace}$(v,u)$\newline 
\phantom{------}{\bf \textsf{if}} $\omega (u)=0$ {\bf \textsf{then}}\newline 
\phantom{---------}$\omega (v):=-1$, $\omega (u):=1$\newline 
\phantom{------}{\bf \textsf{else}}\newline 
\phantom{---------}$\omega (u):=\omega (v):=0$, $t:=u$, {\bf Kontrola-DELETE}$(t)$\newline 
\phantom{------}{\bf \textsf{endif}}\newline 
...
Pozn studenta -- já sám to vždycky chápu tak, že červené vrcholy jsou \uv{špatné} a ukazují nám odchylku od perfektní vyváženosti, takže jich tam nesmí být moc.
...
\subsubsection{Vyvažovací operace}
...
Tj. jde opět o \uv{o 1 špatný} červeno-černý strom.
...
Rozebereme případy. Na obrázku $b$ značí černou barvu a $r$ značí červenou 
...
\begin{enumerate}
    \item Pokud je otec černý, nic neřeším.
    \item Pokud je otec kořen, nemusíme nic řešit a změníme otcovi barvu.
    \item Tedy otec je určitě červený a není kořen. 
    \item Pokud je strýc také červený, přebarvíme otce i strýce (\uv{celou generaci}), ale kvůli počtům musíme přebarvit i děda a propagovat výše. (Viz obrázek \ref{fig3})
    \item Pokud je strýc červený, přebarvit generaci nemůžeme -- místo toho uděláme rotaci. Pokud $t-w-v$ je \uv{rovná}, uděláme jednoduchou rotaci (obrázek \ref{fig4}), pokud je \uv{lomená}, uděláme dvojitou rotaci (obrázek \ref{fig5}); potom přebarvíme tak, aby v~žádné cestě nepřibyl černý uzel.
\end{enumerate}

Popíšeme formálně proceduru {\bf Vyvaz-INSERT$(v)$} (předpokládáme, že 
...
\algoritmus{
{\bf Vyvaz-INSERT$(v)$}.\newline 
{\bf \textsf{if}} $v$ není kořen $T'$ a $b(\otec(v))=0$ {\bf \textsf{then}}\newline 
\phantom{---}{\bf \textsf{if}} $otec(v)$ je kořen {\bf \textsf{then}}\newline 
\phantom{------}$b(\otec(v)):=1$\newline 
\phantom{---}{\bf \textsf{else}}\newline 
\phantom{------}$w:=\otec(v)$, $u:=\bratr(w)$\newline 
\phantom{------}{\bf \textsf{if}} $b(u)=0$ {\bf \textsf{then}}\newline 
\phantom{---------}$v:=\otec(w)$, $b(w):=1$, $b(u):=1$\newline 
\phantom{---------}$b(v):=0$, {\bf Vyvaz-INSERT$(v)$} (Viz Obrázek \ref{fig3})\newline 
\phantom{------}{\bf \textsf{else}}\newline 
\phantom{---------}$t:=\otec(w)$\newline 
\phantom{---------}{\bf \textsf{if}} $s(w)=s(v)$ {\bf \textsf{then}}\newline 
...
Rozdíl je v tom, že u 2-parciálních jsme \uv{slevili} na následnosti červených, naopak tady slevujeme na stejném počtu černých vrcholů.

Rozebereme případy. V následujících obrázcích jsou vrcholy, které 
...
\begin{enumerate}
    ...
    \end{enumerate}
    \item Pokud nejsou oba synovce černé, ale synovec blíž \uv{ke mě} černý je, udělám takovou rotaci, aby se stal mým bratrem, a přebarvíme tak, aby se jednak problémy vyřešily, ale aby \uv{vršek} všeho zůstal stejný. (Obr. \ref{fig8})
    \item Pokud nejsou oba synovce černé a synovec blíž \uv{ke mě} je červený, udělám takovou rotaci, aby byl \uv{nahoře}, a takové přebarvení, aby se problém vyřešil, ale \uv{vršek} byl pořád stejný. (Obr. \ref{fig9})
\end{enumerate}
...
{\bf Vyvaz-DELETE$(v)$\newline 
$u:=\bratr(v)$}, $t:=\otec(v)$\newline 
{\bf \textsf{if}} $b(u)=0$ {\bf \textsf{then}}\newline 
...
{\bf \textsf{if}} $b(w_1)=b(w_2)=1$ {\bf \textsf{then}}\newline 
\phantom{---}$b(u):=0$\newline 
\phantom{---}{\bf \textsf{if}} $b(t):=0$ {\bf \textsf{then}}\newline 
\phantom{------}$b(t):=1$\newline 
\phantom{---}{\bf \textsf{else}}\newline 
\phantom{------}{\bf \textsf{if}} $t$ není kořen stromu {\bf \textsf{then}}\newline \phantom{---------}$v:=t$, {\bf Vyvaz-DELETE}$(v)$\newline 
\phantom{------}{\bf \textsf{endif}}\newline 
\phantom{---}{\bf \textsf{endif}} (Viz Obr. \ref{fig7})\newline 
{\bf \textsf{else}}\newline 
\phantom{---}{\bf \textsf{if}} $b(w_1)=1$ {\bf \textsf{then}}\newline 
(Komentář: $b(w_2)=0$)\newline 
...
\subsubsection{Popis nevyvažovacích operací}
...
\phantom{---}{\bf \textsf{if}} $\levy(t)$ je list {\bf \textsf{then}}\newline 
\phantom{------}$v:=\pravy(t)$\newline 
\phantom{------}{\bf \textsf{if}} $b(t)=1$ a $b(v)=1$ {\bf \textsf{then}}\newline 
\phantom{---------}$vyv:=true$\newline 
\phantom{------}{\bf \textsf{endif}}\newline 
...
\phantom{---}{\bf \textsf{else}}\newline 
\phantom{------}$u:=\levy(t)$\newline 
\phantom{------}{\bf \textsf{while}} $\pravy(u)$ není list {\bf \textsf{do}} $u:=\pravy(u)$ {\bf \textsf{enddo}}\newline 
\phantom{------}$\key(t):=\key(u)$, $v:=\levy(u)$ \newline 
\phantom{------}{\bf \textsf{if}} $b(u)=1$ a $b(v)=1$ {\bf \textsf{then}}\newline 
\phantom{---------}$vyv:=true$\newline 
\phantom{------}{\bf \textsf{endif}}\newline 
...
\phantom{---}{\bf \textsf{endif}} \newline 
\phantom{---}{\bf \textsf{if}} $vyv$ {\bf \textsf{then} Vyvaz-DELETE$(v)$ \textsf{endif}\newline 
\textsf{endif}}
...
{\bf JOIN3$(T_1,x,T_2)$\newline 
\textsf{if}} $b(\text{kořen }T_1)=0$ {\bf \textsf{then}} $b(\text{kořen }T_1)
:=1$ {\bf \textsf{endif}\newline 
\textsf{if}} $b(\text{kořen }T_2)=0$ {\bf \textsf{then}} $b(\text{kořen }T_2)
:=1$ {\bf \textsf{endif}}\newline 
$k_1$ je počet černých vrcholů v $T_1$ z kořene \textsf{do} listů \newline 
$k_2$ je počet černých vrcholů v $T_2$ z kořene \textsf{do} listů \newline 
{\bf \textsf{if}} $k_1\ge k_2$ {\bf \textsf{then}}\newline 
\phantom{---}$t:=\text{ kořen }T_1$, $i:=k_1-k_2$ \newline 
\phantom{---}{\bf \textsf{while}} $i>0$ {\bf \textsf{do}}\newline 
\phantom{------}$t:=\pravy(t)$\newline 
\phantom{------}{\bf \textsf{if}} $b(t)=1$ {\bf \textsf{then}} $i:=i-1$ {\bf \textsf{endif}}\newline 
\phantom{---}{\bf \textsf{enddo}}\newline 
\phantom{---}vytvoř vrchol $u$, $b(u):=0$, $\key(u):=x$\newline 
\phantom{---}{\bf \textsf{if}} $t$ není kořen $T_1$ {\bf \textsf{then}}\newline 
...
{\bf \textsf{while}} $\key(t)\ne x$ a $t$ není list {\bf \textsf{do}}\newline 
\phantom{---}{\bf \textsf{if}} $\key(t)>x$ {\bf \textsf{then}}\newline 
\phantom{------}vlož $(\key(t),\pravy(t))$ \textsf{do} $Z_2$, $t:=\levy(t)$ \newline 
\phantom{---}{\bf \textsf{else}}\newline 
\phantom{------}vlož $(\levy(t),\key(t))$ \textsf{do} $Z_1$, $t:=\pravy(t)$ \newline 
\phantom{---}{\bf \textsf{endif}\newline 
\textsf{enddo} \newline 
\textsf{if}} $\key(t)=x$ {\bf \textsf{then}}\newline 
...
\subsubsection{Korektnost a složitost}
...
\algoritmus{{\bf Oprav$(T,v)$}:\newline 
$t:=\otec(v)$, $\npl(t):=0$\newline 
{\bf \textsf{if}} $\pravy(t)\ne v$ {\bf \textsf{then}} $\levy(t):=\pravy(t)$ {\bf \textsf{endif}\newline 
$\pravy(t):=NIL$\newline 
\textsf{while}} se zmenšilo $\npl(t)$ a $t$ není kořen {\bf \textsf{do}\newline 
\phantom{{\rm ---}}$t:=\otec(t)$\newline 
\phantom{{\rm ---}}\textsf{if}} $\npl(\pravy(t))>\npl(\levy(t))$ {\bf \textsf{then}\newline 
...
Další typ hald je motivován sčítáním přirozených čísel.  
...
\subsubsection{Definice binomiálního stromu}
...
\subsubsection{Vlastnosti binomiálního stromu}
\label{vlasnostibinom}
...
\algoritmus{{\bf MERGE$(\mathcal H_1,\mathcal H_2)$}:\newline 
(komentář: $\mathcal H_i$ reprezentuje množinu $S_i$ pro $i=1
,2$ a $S_1\cap S_2=\emptyset$)\newline 
$i:=0$, $T:=$prázdný strom, $\mathcal H:=\emptyset$\newline 
{\bf \textsf{while}} $i<\log(|S_1|+|S_2|)$ {\bf \textsf{do}\newline 
\phantom{{\rm ---}}\textsf{if}} existuje $U\in \mathcal H_1$ izomorfní s~$
H_i$ {\bf \textsf{then}\newline 
\phantom{{\rm ------}}$U_1:=U$\newline 
\phantom{{\rm ---}}\textsf{else}\newline 
\phantom{{\rm ------}}$U_1:=$}prázdný strom\newline 
\phantom{---}{\bf \textsf{endif}\newline 
\phantom{{\rm ---}}\textsf{if}} existuje $U\in \mathcal H_2$ izomorfní s~$
H_i$ {\bf \textsf{then}\newline 
\phantom{{\rm ------}}$U_2:=U$\newline 
\phantom{{\rm ---}}\textsf{else}\newline 
\phantom{{\rm ------}}$U_2:=$}prázdný strom\newline 
\phantom{---}{\bf \textsf{endif}\newline 
\phantom{{\rm ---}}\textsf{case}\newline 
\phantom{{\rm ------}}}(existuje právě jeden neprázdný strom 
$V\in \{T,U_1,U_2\}$) {\bf \textsf{do}}:\newline 
\phantom{---------}vlož $V$ {do} $\mathcal H$, $T:=$prázdný strom\newline 
\phantom{------}(existují právě dva neprázdné stromy 
$V_1,V_2\in \{T,U_1,U_2\})$ {\bf \textsf{do}}:\newline 
\phantom{---------}$T:=${\bf spoj$(V_1,V_2)$\newline 
\phantom{{\rm ------}}}(všechny stromy $T$, $U_1$ a $U_2$ jsou neprázdné) {\bf \textsf{do}}:\newline 
\phantom{---------}vlož $T$ \textsf{do} $\mathcal H$, $T:=${\bf spoj$(U_1,U_
2)$\newline 
\phantom{{\rm ---}}\textsf{endcase}\newline 
\phantom{{\rm ---}}$i:=i+1$\newline 
\textsf{enddo}\newline 
\textsf{if}} $T\ne$prázdný strom {\bf \textsf{then}} vlož $T$ {do} $\mathcal H$ {\bf \textsf{endif}\newline 
Výstup}:$\mathcal H$}
...
\uv{vyvažování} stačí provádět jen při operacích {\bf MIN} a 
...
\subsubsection{Velmi neformální definice}
Fibonacciho halda je opět kolekce stromů. Jde tu ale o to, že ve Fibonacciho haldě je v~každém stromě s~$k$ syny alespoň
$F_{k+2}$ prvků -- toho dosáhneme tak, že se halda strašně \uv{často} rozpadá
-- každému vrcholu můžeme odebrat maximálně jednoho syna. Jakmile bychom mu
chtěli odebrat dalšího, tak ho místo toho useknem a dáme jako další strom.

\subsubsection{Méně neformální definice}
...
$i:=0$, $\mathcal H:=\emptyset$\newline 
{\bf \textsf{while}} existuje $O_i\ne\emptyset$ {\bf \textsf{do}\newline 
\phantom{{\rm ---}}\textsf{while}} $|O_i|>1$ {\bf \textsf{do}\newline 
\phantom{{\rm ------}}}vezmi dva různé stromy $T_1$ a $
T_2$ z 
$O_i$\newline 
\phantom{------}odstraň je z $O_i$\newline 
\phantom{------}{\bf spoj$(T_1,T_2)$} vlož \textsf{do} $O_{i+1}$\newline 
\phantom{---}{\bf \textsf{enddo}\newline 
\phantom{{\rm ---}}\textsf{if}} $O_i\ne\emptyset$ {\bf \textsf{then}\newline 
\phantom{{\rm ------}}}strom $T\in O_i$ odstraň z $O_i$ a vlož ho \textsf{do} $
\mathcal H$\newline 
\phantom{---}{\bf \textsf{endif}\newline 
\phantom{{\rm ---}}$i:=i+1$\newline 
\textsf{enddo}\newline 
...
\phantom{---}{\bf \textsf{for every}} $j=1,2,\dots,\lceil\frac n5\rceil$ {\bf do\newline 
