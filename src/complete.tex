\documentclass[a4paper,12pt]{article}
 ...
 \begin{center}
 $\vcenter{
 \hbox{\raisebox{-0.7ex}{\scalebox{1.7}{\Huge\RIGHTarrow}}\begin{boxedminipage}{0.8\textwidth}
\large #1
...
\begin{lemma}
    Řetězec délky $l$ přispěl k součtu 
...
Sčítáme všechny možné $C$ jako součet přes všechny možné řetězce \emph{vůbec}.
